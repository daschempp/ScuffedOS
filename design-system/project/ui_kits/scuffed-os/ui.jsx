...
function Button({ variant = "primary", size = "md", iconLeft, iconRight, fullWidth, children, ...rest }) {
  return (
...
function IconButton({ variant = "ghost", size = "md", label, children, ...rest }) {
  return (
...
function Card({ variant = "default", title, eyebrow, action, className = "", children, ...rest }) {
...
function Badge({ color = "neutral", dot, icon, children, ...rest }) {
  return (
...
function Avatar({ name = "", src, size = "md", tint = "green", ...rest }) {
...
function Stat({ label, value, unit, icon, delta, trend = "up" }) {
  return (
...
function ProgressBar({ value = 0, max = 100, label, meta, color = "green", size = "md" }) {
...
function ProgressRing({ value = 0, max = 100, size = 72, thickness = 9, color = "green", trackColor = "var(--paper-300)", label, sublabel }) {
...
function Checkbox({ checked, onChange, label, strikeWhenChecked }) {
  return (
...
Object.assign(window, { Icon, Button, IconButton, Card, Badge, Avatar, Stat, ProgressBar, ProgressRing, Checkbox, Switch });
